...
def when(context):
    time.sleep(5)
    WebDriverWait(context.driver, 15).until(expected_conditions.visibility_of_element_located((By.ID, "create")))
...
#    wait_spinner(context.driver)
    ...
    title_field.click()
    title_field.send_keys(Keys.PAGE_DOWN)
    time.sleep(3)
...
def then(context):
    WebDriverWait(context.driver, 15).until(expected_conditions.text_to_be_present_in_element((By.XPATH, "/html/body/app-root/app-sidebar-layout/div/div/app-alert-system/div/div/div[1]/span[2]"), "Topic created!"))
    ...
    WebDriverWait(context.driver, 15).until(expected_conditions.visibility_of_element_located((By.XPATH, "/html/body/app-root/app-sidebar-layout/div/div/app-topics/div/app-custom-card[2]/div/div[2]/div/div[4]/div[1]/div[1]/div/button")))
