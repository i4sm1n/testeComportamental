...
#    wait_spinner(context.driver)
    ...
    search_company_field = context.driver.find_element_by_xpath("name")
...
def when(context):
    ...
    delete_btn = context.driver.find_element_by_id("undefined")
    delete_btn.click()

    confirmDelete_btn = context.driver.find_element_by_xpath("/html/body/app-root/app-sidebar-layout/div/div/app-topics/div/app-custom-card[2]/div/div[2]/div/div[4]/div/div[2]/div/app-btn-confirm/button[2]/div[1]")
